...
class MskConsumerConfigTest {
    ...
    void iamAuthEmitsExpectedSaslProperties() {
        KafkaConsumerConfig config = MskConsumerConfig.iamAuth(
    ...
    void saslScramEmitsExpectedScramProperties() {
        KafkaConsumerConfig config = MskConsumerConfig.saslScram(
                "broker:9096",
                "test-group",
                "fake-user",
                "fake-password");
    ...
    void nullArgumentsAreRejected() {
        assertThrows(NullPointerException.class,
                () -> MskConsumerConfig.iamAuth(null, "g", "us-east-1"));
        assertThrows(NullPointerException.class,
                () -> MskConsumerConfig.iamAuth("b", null, "us-east-1"));
        assertThrows(NullPointerException.class,
                () -> MskConsumerConfig.iamAuth("b", "g", null));
        assertThrows(NullPointerException.class,
                () -> MskConsumerConfig.saslScram(null, "g", "u", "p"));
        assertThrows(NullPointerException.class,
                () -> MskConsumerConfig.saslScram("b", null, "u", "p"));
        assertThrows(NullPointerException.class,
                () -> MskConsumerConfig.saslScram("b", "g", null, "p"));
        assertThrows(NullPointerException.class,
                () -> MskConsumerConfig.saslScram("b", "g", "u", null));
    }
